...
export class CatalogComponent {
  ...
  ngOnInit() {
    ...
    // this.filter = this.route.snapshot.params['filter']; // only when component does not change route itself
  ...
  addToCart(product: IProduct) {
    ...
    this.router.navigate(['/cart']);  // defines the url to where you want the browser to navigate to.
  }
